...
规划中的 Skill 清单**只在一处维护**——[`team-ai-workspace-bootstrap`](.agents/skills/team-ai-workspace-bootstrap/SKILL.md) 的「配套 Skills」一节（含 SpringBoot / Vue Admin 走查、SQL 变更安全检查等），以避免两处列表各写一份、日久漂移。新增规划项时只改那一处。
