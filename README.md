...
| [`team-ai-workspace-bootstrap`](.agents/skills/team-ai-workspace-bootstrap/SKILL.md) | 「初始化下项目」、新项目接入 AI 规范、统一 AGENTS.md | **分析 + 预填**：探测项目结构/技术栈/数据库后，生成含真实内容的 AGENTS.md（含 AI 行动边界）并预填 overview.md 心智模型初稿——不交付空骨架 |
